...
public class LibraryCardController {
    ...
    @PostMapping
    public ResponseEntity<LibraryCardResponse> createLibraryCard(@PathVariable String userId, LibraryCardRequest libraryCardRequest) {
    ...
    @PutMapping
    public ResponseEntity<LibraryCardResponse> updateLibraryCard(@PathVariable String userId, LibraryCardRequest libraryCardRequest) {
